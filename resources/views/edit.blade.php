            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="religion" id="inlineRadio3" value="islam"
                        @if ($student->religion == 'islam') checked @endif>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="religion" id="inlineRadio4" value="kristen"
                        @if ($student->religion == 'kristen') checked @endif>
                    <label class="form-check-label" for="inlineRadio4">Kristen</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="religion" id="inlineRadio3" value="islam"
                        @if ($student->religion == 'hindu') checked @endif>
                    <label class="form-check-label" for="inlineRadio3">Hindu</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="religion" id="inlineRadio3" value="islam"
                        @if ($student->religion == 'budha') checked @endif>
